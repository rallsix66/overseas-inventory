...
| OPT-6 Batch 3 00052 product-policy overlap (Staging SELECT-only FINAL PASS; Production SELECT-only preflight FINAL PASS; Production 00052 apply packet independently reviewed PASS; controlled Production window pending; Production write and Batch 4 prohibited) | [Batch 3 report](reports/2026-07-22-opt6-quality-governance-batch-3.md) -> [Staging report](reports/2026-07-27-opt6-00052-staging-preflight.md) -> [Staging evidence](reports/evidence/2026-07-27-opt6-00052-staging-preflight.md) -> [Production preflight report](reports/2026-07-28-opt6-00052-production-preflight.md) -> [Production preflight evidence](reports/evidence/2026-07-28-opt6-00052-production-preflight.md) -> [Production preflight SQL](reports/sql/2026-07-28-opt6-00052-production-preflight.sql) -> [Production static contract](../src/features/database/opt6-00052-production-preflight.test.ts) -> [Production PostgreSQL contract](../src/features/database/opt6-00052-production-preflight.postgres.test.ts) -> [Production apply report](reports/2026-07-28-opt6-00052-production-apply.md) -> [Production apply evidence](reports/evidence/2026-07-28-opt6-00052-production-apply.md) -> [Production apply SQL](reports/sql/2026-07-28-opt6-00052-production-apply.sql) -> [Production apply contract](../src/features/database/opt6-00052-production-apply.test.ts) -> [Production apply PostgreSQL contract](../src/features/database/opt6-00052-production-apply.postgres.test.ts) |
