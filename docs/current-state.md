...
`P4-U2` — 用户列表只读页面（**DONE**，2026-07-01）
...
- **P4-U2**：DONE（2026-07-01）。用户列表只读页面完成。Admin-only 访问，searchParams 筛选（状态+角色）+ 分页 + 行详情 Sheet。41 项新测试。2059/2060 tests。
...
- **P4-U3**（修改角色）：已解除阻塞（依赖 P4-U2 DONE）。可复用 `updateUserRole` action + P4-U2 页面。
- **P4-U4**（启用/禁用）：依赖 P4-U3，BLOCKED。

**Last Updated**: 2026-07-01 P4-U2 DONE。Phase 4 用户管理只读列表已完成；Phase 3 内部路径全完成。
