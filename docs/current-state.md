...
- P5-SY10D 待 Codex 独立验收。P5-SY10E~F 待启动。P5-SY11 ProductVariant 软归档与库存视图降噪记入后置计划。
...
P5-SY10D AWAITING_REVIEW — 预审页面 UI（自动预审入口 + RuleBadge + 规则详情展开 + WARN 可选/BLOCK 不可选）。P5-SY11 软归档后置，当前不启动。WEBSYNC_REAL_WRITE_ENABLED 仍 disabled。下一步 P5-SY10E（调度机制）。
