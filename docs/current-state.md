...
- **P4-U4**：DONE（2026-07-01）。启用/禁用账号功能完成。UserDetailSheet + UserActiveToggleDialog 确认对话框。复用现有 toggleUserActive action（自禁用 + 最后管理员保护）。29 项测试。2125/2125 tests。
...
**Last Updated**: 2026-07-01 P4-U4 DONE。Phase 4 用户管理（列表 + 角色变更 + 启用禁用）已完成；用户管理 CRUD 已形成闭环。P4-U5 安全与流程验收已解除阻塞。
...
2026-07-01 — P4-U4 DONE。Phase 4 用户管理（列表 + 角色变更 + 启用禁用）已完成；用户管理 CRUD 已形成闭环。P4-U5 安全与流程验收已解除阻塞。
