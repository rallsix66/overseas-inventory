...
`P3-S4A` — 内部手动在途状态轨迹收口（**DONE**，2026-06-30）
...
**Current Task**: P3-S4A DONE（2026-06-30）。P3-S2E DONE。P3-S1B CODE COMPLETE / BLOCKED_EXTERNAL。P3-S3 DONE。详情见下方 Next Step。
...
| 新 Migration（P3-S4A） | 00022（change_shipment_status_transactional 状态流转规则校验 — 禁止倒退/跳步/warehoused）待用户在 Supabase SQL Editor 手动执行 |
