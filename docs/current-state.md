...
`P4-U1` — 用户数据层、邮箱字段与权限收口（**DONE — 返工完成**，2026-07-01）
...
- **P4-U1**：DONE — 返工完成（2026-07-01）。初始修复 7 项 + 返工修复 5 项真实行为风险（email helper 错误传播、updateRole/toggleActive 行存在确认、countByRole 显式 join、getRoleName PGRST116 区分）。63 项测试（+13 返工）。2018/2019 tests（1 预存 live test 失败），lint 0，build pass。
...
**Last Updated**: 2026-07-01 P4-U1 返工完成。Phase 4 用户管理数据层已收口；Phase 3 内部路径全完成。
