...
| **P5-SY10D** | 预审页面 UI：自动预审入口 + 规则决策徽标 + 可展开规则详情 | Sync 页面新增「自动预审」按钮。BatchReviewCard 新增 RuleBadge + 可展开规则详情 + WARN 可选/BLOCK 不可选。21 项新测试。672/672 TS。 | P5-SY10C | AWAITING_REVIEW |
