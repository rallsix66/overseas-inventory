...
| **P5-SY10B** | 历史上下文提供器：基线追踪 + 连续失败检测 | 实现 `getWarehouseHistory()` 从 sync_run/sync_log 推导历史基线；走 Repository 接口 | P5-SY10A | **DONE**（2026-06-24。31 项测试。617/617 TS，lint 0，build pass） |
