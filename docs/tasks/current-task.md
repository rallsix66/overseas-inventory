...
`IN_PROGRESS` — P5-SY9A~F DONE（P5-SY9F Codex 独立复验通过）；P5-SY9G IN PROGRESS；P5-SY9H~I PENDING。
...
| P5-SY9G | 批量审核后真实写入 | 勾选 ready 仓库，强确认后逐仓写入；单仓失败不影响其他仓 | P5-SY9F | IN PROGRESS |
