...
**DONE**（2026-07-02，P3-S5B0/B1/B2/B3/B4 全部完成）
...
- 新增 `listEligibleForBatchWarehousingAction` Server Action（Admin-only + 仓库隔离 + ShipmentError 中文传播）
...
P3-S5B4 通过：
- shipments 881/881（14 文件，新增 p3-s5b4-batch-warehouse.test.ts 61 项）
- 全量 2443/2443（61 文件）
- build pass
