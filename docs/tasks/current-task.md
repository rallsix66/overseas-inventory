...
**OPT-2-TEST-COVERAGE — IMPLEMENTATION IN PROGRESS / REMOTE DB VERIFY PENDING**
...
- 本机没有可用 Docker/PostgreSQL；数据库行为结果必须由 PR 的隔离 PostgreSQL job 给出，不允许改连 Production/Staging。
